        ...
        <div>
            ...
            <div className="col-12" style={{height:"260px",position:"relative"}}>
                {/* jugggad */}
                    ...
                    <img src={ data.cover_pic==="" ? "https://plchldr.co/i/250x215?&bg=b2b2b2&text=" : data.cover_pic } alt="Cover_pic" class="img-fluid col-12" style={{ height: '199px'}} />
            </div>

            <div className="col-11 d-flex flex-row" style={{ margin:"auto",justifyContent:"space-between" }}>
                <div className="col-3" >
                        <img src={data.profile_pic==="" ? "https://plchldr.co/i/250x215?&bg=b2b2b2&text=" : data.profile_pic  } class="img-fluid" alt="profile_pic" width="135px"  style={{bottom:"0px",position: 'absolute',borderRadius:"50%",border:"4px solid white",height:"135px"}}/>
                </div>
            ...
            <div className="col-12">
                { slider===0 ? <div className="col-12 m-5" style={{textAlign:"center"}}>
                    tweets
                </div> : slider===1 ? <div className="col-12 m-5" style={{textAlign:"center"}}>
                    Tweets repilies
                </div> : slider===2 ? <div className="col-12 m-5" style={{textAlign:"center"}}>
                    Media
                </div> : <div className="col-12 m-5" style={{textAlign:"center"}}>
                    Likes
                </div> }
            </div>
