...
import {Covid,Business,Technology,Sports,Politics} from "./DisplayNews"
import "../../App.css"
      ...
      <TabContext value={value}>
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }} variant="fullWidth" >
          <TabList onChange={handleChange} aria-label="lab API tabs example" >              
            ...
            <Tab label="Business" value="4" style={explore_tabs}/>
            <Tab label="Sports" value="3" style={explore_tabs}/>
